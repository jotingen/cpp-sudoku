...
- Replace all occurrences of "Sudoku" in the relevant CMakeLists.txt with the name of your project
  - Capitalization matters here: `Sudoku` means the name of the project, while `sudoku` is used in file names.
  - Remember to rename the `include/sudoku` directory to use your project's lowercase name and update all relevant `#include`s accordingly.
